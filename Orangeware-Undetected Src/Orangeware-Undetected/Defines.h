...
namespace Offsets
{
	...
	uintptr_t OwningGameInstance = 0x1a8; //World
	...
	uintptr_t PrimaryPickupItemEntry = 0x2f8; //FortPickup
	uintptr_t ItemDefinition = 0x18; //FortItemEntry
	uintptr_t DisplayName = 0x90; //FortItemDefinition
	uintptr_t Tier = 0x74; //FortItemDefinition
	uintptr_t bComponentToWorldUpdated = 0x14C; //SceneComponent
	uintptr_t ComponentVelocity = 0x140; //SceneComponent
	uintptr_t Levels = 0x160; //World
	...
	uintptr_t RootComponent = 0x188; //Actor
	uintptr_t RelativeLocation = 0x128; //SceneComponent
	uintptr_t RelativeRotation = 0x140; //SceneComponent
	uintptr_t PlayerState = 0x290; //Pawn
	uintptr_t Mesh = 0x2f0; //Character
	...
	uintptr_t TeamIndex = 0x1010; //FortPlayerStateAthena
